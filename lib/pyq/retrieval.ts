...
// ── Embedding ─────────────────────────────────────────────────────────────────
// Semantic embeddings are disabled: Claude (Anthropic) does not provide an
// embeddings API, and the Supabase PYQ data was indexed with Gemini vectors.
// Switching embedding providers would produce incorrect similarity scores.
